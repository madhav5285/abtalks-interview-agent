        ...
        {evaluation ? (
          <div className="flex-1 p-8 overflow-y-auto max-w-3xl mx-auto w-full">
            <div className="bg-slate-900 border border-emerald-500/30 rounded-2xl p-8 shadow-2xl">
              ...
              <p className="text-sm text-slate-400 mt-1">Score: {evaluation.overallScore} / 100</p>
              <p className="text-slate-300 text-sm mt-4 bg-slate-800/40 p-4 rounded-lg">{evaluation.summary}</p>
            </div>
          </div>
        ) : (
          ...
          <footer className="p-4 border-t border-slate-800 bg-slate-900">
            <div className="flex gap-3 max-w-4xl mx-auto">
              ...
              <button
                onClick={handleSend}
                disabled={loading}
                className="bg-blue-600 hover:bg-blue-500 text-white px-6 py-3 rounded-xl font-medium text-sm transition-colors"
              >
